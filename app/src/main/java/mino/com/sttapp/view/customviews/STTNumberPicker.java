package mino.com.sttapp.view.customviews;
...
//                setItemsFont(attributes.getInt(R.styleable.STTNumberPicker_itemsTitleSize, DEFAULT_FONT));
...
//            ((EditText) view).setTextSize(TypedValue.COMPLEX_UNIT_PX, getItemsSize());
//            ((EditText) view).setTextColor(getItemsColor());
        }
    }
